...
Public Class MenTshirt
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        con.Close()
        dt = ds.Tables(0)
        ImageButton3.ImageUrl = dt.Rows(20).Item(3)
        ImageButton4.ImageUrl = dt.Rows(21).Item(3)
        ImageButton5.ImageUrl = dt.Rows(22).Item(3)
        ImageButton6.ImageUrl = dt.Rows(23).Item(3)
        conclose()
    End Sub
    ...
    Protected Sub ImageButton3_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ImageButton3.Click
        Response.Redirect("m_shirt_Description.aspx?Data=" & Server.UrlEncode(Label2.Text))

    End Sub

    Protected Sub ImageButton4_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ImageButton4.Click
        Response.Redirect("m_shirt_Description.aspx?Data=" & Server.UrlEncode(Label4.Text))

    End Sub

    Protected Sub ImageButton5_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ImageButton5.Click
        Response.Redirect("m_shirt_Description.aspx?Data=" & Server.UrlEncode(Label6.Text))
    ...
    Protected Sub ImageButton6_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ImageButton6.Click
        Response.Redirect("m_shirt_Description.aspx?Data=" & Server.UrlEncode(Label8.Text))
