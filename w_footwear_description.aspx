<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="w_footwear_description.aspx.vb" Inherits="WebApplication3.w_footwear_description" %>
...
&nbsp;
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Label ID="Label6" runat="server" Font-Bold="True" Text="size"></asp:Label>
&nbsp;
        <asp:DropDownList ID="DropDownList2" runat="server" Height="18px" Width="84px">
        ...
        &nbsp;<asp:Image ID="Image2" runat="server" Height="20px" ImageUrl="~/images/4.jpg" 
            Width="85px" />
    ...
    <asp:Panel ID="Panel4" runat="server" BackColor="#FFFFCC" Height="715px" 
        ...
        <asp:Panel ID="Panel5" runat="server" BackColor="#FFFF99" Height="120px" 
            ...
            <br />
            &nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Label ID="Label9" runat="server" Text="Brand :" Width="200px" 
