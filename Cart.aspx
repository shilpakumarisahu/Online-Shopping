<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="Cart.aspx.vb" Inherits="WebApplication3.Payment" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <asp:Panel ID="Panel1" runat="server" BackColor="#FFFFCC" Height="1516px">
        ...
        <asp:Panel ID="Panel8" runat="server" BorderStyle="Solid" BorderWidth="1px" 
            ...
            <asp:Label ID="Label24" runat="server" Width="100px"></asp:Label>
            <br />
            &nbsp;<asp:Label ID="Label25" runat="server" Width="200px"></asp:Label>
            <asp:Label ID="Label26" runat="server" Width="100px"></asp:Label>
            <asp:Label ID="Label27" runat="server" Width="100px"></asp:Label>
            <br />
        ...
        <asp:Panel ID="Panel9" runat="server" BorderStyle="Solid" BorderWidth="1px" 
            Direction="RightToLeft" Height="30px" style="margin-left: 50px" Width="820px">
            &nbsp;&nbsp;&nbsp;
            <asp:Label ID="Label32" runat="server" Width="100px"></asp:Label>
            <asp:Label ID="Label31" runat="server" Text="GRAND TOTAL :"></asp:Label>
        </asp:Panel>
        <br />
        ...
        <asp:Panel ID="Panel3" runat="server" BackColor="#FFFF99" Height="715px" 
            ...
            <asp:ImageButton ID="ImageButton3" runat="server" BorderStyle="Solid" 
                BorderWidth="1px" Height="35px" ImageUrl="~/images for site/place.jpg" Width="135px" />
        </asp:Panel>
    </asp:Panel>
    <br />
</asp:Content>
